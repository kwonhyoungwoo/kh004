        ...
        <div id="header_mid">
            ...
            <div class="search_box">
                <form action="/item/search" method="get">
                    <input name="search" class="" type="search" placeholder="검색어를 입력해주세요">
                    <button type="submit">
...
<script>
    $(document).ready(function () {
        $.ajax({
            url: "/primary-category-list",
            type: "post",
            dataType: "json",
            success: function (data) {
                $.each(data, function (i) {
                    $('#cateList').append('<li><a href="/item/' + data[i].primaryCategory + '">' + data[i].primaryCategory + '</a></li>');
                });
            },
            error: function () {
                alert('error');
