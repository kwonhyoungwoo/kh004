...
public class AdminController {
    ...
    public String productListView(@RequestParam("no") int product_no, Model model){
    ...
    @RequestMapping("/admin/productList/productListInsert")
    public String memberListAdd(){
        return "admin/product/productListInsert";
    }
